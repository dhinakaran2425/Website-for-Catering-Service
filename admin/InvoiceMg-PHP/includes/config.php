...
define('COMPANY_NAME','Balaji Catering Service');
define('COMPANY_ADDRESS_1','507,S K C Mainroad');
define('COMPANY_ADDRESS_2','Surampatti');
define('COMPANY_ADDRESS_3','Erode');
define('COMPANY_COUNTY','India');
define('COMPANY_POSTCODE','638009');

define('COMPANY_NUMBER','Company No: 6374610120'); // Company registration number
define('COMPANY_VAT', 'Company VAT: 6374610120'); // Company TAX/VAT number

// EMAIL DETAILS
define('EMAIL_FROM', 'sribalajicateringserviceerode@gmail.com'); // Email address invoice emails will be sent from
define('EMAIL_NAME', 'Balaji Catering Service'); // Email from address
...
define('PAYMENT_DETAILS', 'Balaji Catering Service.<br>Sort Code: 00-00-00<br>Account Number: 12345678'); // Payment information
define('FOOTER_NOTE', 'Balaji Catering Service');
