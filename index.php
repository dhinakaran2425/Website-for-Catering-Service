		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br>Sri Balaji Food Catering Service</strong></h1>
							<p class="m-b-40">Have It Your Way,   <br> 
							World's Greatest Veg Items</p>
				...
				<div class="col-9">
					<div class="tab-content" id="v-pills-tabContent">
						...
						<div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
							<div class="row">
                             <?php include "connect.php";
								$s = mysqli_query($con,"select * from menu where category='Dinner'");
								while($r = mysqli_fetch_array($s))
								{	
								?>
								<div class="col-lg-4 col-md-6 special-grid drinks">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for Balaji Catering Service Listed Here </p>
					</div>
				</div>
			</div>
					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						...
						<?php } ?>
							<div class="carousel-item text-center active">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Vishva</strong></h5>
