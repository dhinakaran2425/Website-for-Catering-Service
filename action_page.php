...
if(isset($_SESSION['uid']))
{
	...
	$s= mysqli_query($con,"select * from addcart_1 where u_id='$uid'");
	while($r = mysqli_fetch_array($s))
	{
		$p_id = $r['p_id'];
		mysqli_query($con,"insert into checkout_1(p_id, u_id,edate,name,mobile,email,location,transactionid) values('$p_id','$uid', '$edate', '$nm','$mo','$em','$ad','$transactionid')") or die("Error");
	?>
...
?>
	...
	<div class="input-group">
                                <form method="post" action="invoice-main/index.php">
     <input type="submit" name="invoice" class="button" value="Invoice" />
    </form></div>
