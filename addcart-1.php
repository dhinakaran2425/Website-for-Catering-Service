	...
	<form action="" method="post">
		...
		<table align="center" border="1" cellspacing="14" cellpadding="12" style="color: black" >
			    ...
			    <tr align="center">
			        ...
			        <td> <input type="number" name="qty" value="" min=20 max=150 required></td>
			    </tr>
			...
			if(isset($_POST['sb']))
			{
				...
				include "connect.php";
				mysqli_query($con,"insert into addcart_1(p_id,u_id,price,qty,total ) values('$pid','$uid','$price','$qty','$total')") or die(mysqli_error($con));
				echo "<script>alert('Your data Is Add Inside Cart')</script>";
				header('URL = border.php');
